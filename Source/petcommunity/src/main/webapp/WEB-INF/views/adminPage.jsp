	...
	<div class="container">
		<section id="container">
			...
			<div id="tab-1" class="tab-content current">
				<div class="search">
					<form action="/petcommunity/datesearch.do" id="datesearch"
						name="datesearch">

						<div class="input-group">
							<input type="date" name="startDate" class='form-control'
								id="startDate" /> <input type="date" name="endDate"
								class='form-control' id="endDate" /> <input id="adminsearchBtn"
								type="submit" class="btn btn-default" value="검색"> <a
								href="/petcommunity/adminPage.do" id="listBtn"
			...
			<div id="tab-2" class="tab-content">
				<div id="graph_04_outer_container"
					class="graph_outer_container_full">
			...
			<div id="tab-3" class="tab-content">
				...
				<div class="col-xs-10 col-sm-10">
					<div class="input-group">
						<span id="search-container"> <input type="text"
							name="searchWord" class='form-control' id="searchWord"
							placeholder="검색어를 입력하세요." />
							<button id="searchBtn" type="button" class="btn btn-default">검색</button>
							<a href="/petcommunity/loadInsertProduct.do" id="writeBtn"
					...
					<table id="productDataTable" class="table table-hover">
						...
						<thead>
							<tr>
								...
								<th scope="col"
									style="width: 56px; padding-left: 0px; padding-right: 0px;">카테고리</th>
								<th scope="col"
									style="width: 56px; padding-left: 0px; padding-right: 0px;">상품내용</th>
								<th scope="col">수정</th>
								<th scope="col">삭제</th>
							</tr>
						</thead>
