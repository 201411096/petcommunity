...
<body>
		...
		<div class="hero-slider owl-carousel">
			<div class="hs-item">
				<div class="hs-bg set-bg sm-overlay"
					data-setbg="./resources/bootstrap_template/bootstrap_seyeong/img/slider/cover.png"></div>
	...
	<script src="./resources/bootstrap_template/bootstrap_seyeong/js/bootstrap.min.js"></script>
	<script src="./resources/bootstrap_template/bootstrap_seyeong/js/jquery.slicknav.min.js"></script>
