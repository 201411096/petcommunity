...
<head>
	...
	<!-- Favicon -->
	<link href="./resources/bootstrap_template/bootstrap_seyeong/img/favicon.ico" rel="shortcut icon"/>
	...
	<!-- Main Stylesheets -->
	<link rel="stylesheet" href="./resources/bootstrap_template/bootstrap_seyeong/css/style.css"/>
...
<body>
	...
	<header class="header-section">
		<div class="header-warp">
			<a href="index.html" class="site-logo">
				<img src="./resources/bootstrap_template/bootstrap_seyeong/img/logo.png" alt="">
			</a>
			<ul class="main-menu">
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item">
				<div class="hs-bg set-bg sm-overlay" data-setbg="./resources/bootstrap_template/bootstrap_seyeong/img/slider/1.jpg"></div>
			...
			<div class="row m-0">
				<div class="col-md-6 p-0">
					<div class="gallery-left-col">
						...
						<div class="gallery-item">
							<img src="./resources/bootstrap_template/bootstrap_seyeong/img/gallery/1.jpg" alt="#">
							<h4>Red Passion 2017</h4>
							<p>Artist: John Doe</p>
							<a href="#" class="site-btn">view gallery <img src="./resources/bootstrap_template/bootstrap_seyeong/img/icons/arrow-right-black.png" alt=""></a>
						</div>
						<div class="gallery-item">
				...
				<div class="col-md-6 p-0">
					<div class="gallery-right-col">
						<div class="gallery-item">
							<img src="./resources/bootstrap_template/bootstrap_seyeong/img/gallery/4.jpg" alt="#">
							<h4>Red Passion 2017</h4>
							<p>Artist: John Doe</p>
							<a href="#" class="site-btn">view gallery <img src="./resources/bootstrap_template/bootstrap_seyeong/img/icons/arrow-right-black.png" alt=""></a>
						</div>
						...
						<div class="more-gallery text-left text-md-right">
							<a href="#" class="site-btn sb-big">see all galleries <img src="./resources/bootstrap_template/bootstrap_seyeong/img/icons/arrow-right-black.png" alt=""></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="blog-content-col">
				<div class="blog-item">
					<div class="blog-thumb">
						<img src="./resources/bootstrap_template/bootstrap_seyeong/img/blog/1_thumb.jpg" alt="">
					</div>
					<div class="blog-content">
						...
						<a href="#" class="site-btn">Read More <img src="./resources/bootstrap_template/bootstrap_seyeong/img/icons/arrow-right-black.png" alt=""></a>
					</div>
				</div>
				<div class="blog-item">
					<div class="blog-thumb">
						<img src="./resources/bootstrap_template/bootstrap_seyeong/img/blog/2_thumb.jpg" alt="">
					</div>
					<div class="blog-content">
						<span class="blog-cata">photography</span>
					...
					<form class="contact-form">
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<button class="site-btn sb-light" type="submit">send message <img src="./resources/bootstrap_template/bootstrap_seyeong/img/icons/arrow-right-white.png" alt=""></button>
							</div>
						</div>
					</form>
				</div>
