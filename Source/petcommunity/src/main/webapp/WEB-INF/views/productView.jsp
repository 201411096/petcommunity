										...
										<ul class="list">
											<li>
												<a href="#">5 Star
													...
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i> ${score5Size}</a>
											</li>
											<li>
												<a href="#">4 Star
													<i class="fa fa-star"></i>
													...
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star-o"></i> ${score4Size}</a>
											</li>
											<li>
												<a href="#">3 Star
													<i class="fa fa-star"></i>
													...
													<i class="fa fa-star-o"></i> ${score3Size}</a>
											</li>
											<li>
												<a href="#">2 Star
													<i class="fa fa-star"></i>
													...
													<i class="fa fa-star-o"></i>
													<i class="fa fa-star-o"></i>
													<i class="fa fa-star-o"></i> ${score2Size}</a>
											</li>
											<li>
												<a href="#">1 Star
													<i class="fa fa-star"></i>
													...
													<i class="fa fa-star-o"></i>
													<i class="fa fa-star-o"></i>
													<i class="fa fa-star-o"></i> ${score1Size}</a>
											</li>
										</ul>
									</div>
								</div>
...
<!-- 									</div> -->
									...
									<div class="col-md-12">
										<div class="form-group">
											<textarea class="form-control" id="productreviewContent" placeholder="내용을 작성해 주세요" rows="10"></textarea>
										</div>
									</div>
									<div class="col-md-12 text-right">
										<button type="button" value="submit" id="btn_modify" class="btn submit_btn" style="display:none;">수정하기</button>
										<button type="button" value="submit" id="btn_reviewSubmit" class="btn submit_btn" style="display:block;">작성하기</button>
